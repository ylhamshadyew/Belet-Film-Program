...
* **Не копировать контент сайта** (видео, текст, изображения) — все права принадлежат владельцам **JAN Tehnologiya**.
* **Не использовать логотипы и торговые марки без разрешения!**
* Клиент предназначен **только для личного и образовательного использования**, не для коммерческого распространения.
